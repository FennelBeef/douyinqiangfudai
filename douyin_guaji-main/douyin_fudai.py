...
"""
    ...
    4.增加自动刷视频的功能，增加账号活跃度，提升中奖概率
    5.增加直播间互动的功能，增加账号活跃度，提升中奖概率
    6.处理异常操作导致弹窗：账号存在风险的验证
    7.兼容IOS系统，苹果手机也能挂机
    8.其他来自粉丝们需要的建议
...
class fudai_analyse:
    ...
    def check_lucky_draw_result(self):
        ...
        lucky_draw_result = self.operation.analyse_pic_word('lucky_draw_result',1)
        # print("lucky_draw_result="+lucky_draw_result)
        if "没有抽中福袋" in lucky_draw_result:
