...
class underlying_operations:
    ...
    def get_screenshot(self, device_id, path='pic'):
        ...
        try:
            ...
            subprocess.Popen(
                'adb  -s %s pull /sdcard/DCIM/screenshot.png %s/screenshot.png ' % (device_id, path),
    ...
    def swipe(self, device_id, left_up_x=0, left_up_y=0, right_down_x=1080, right_down_y=1500, steps=200):
        """划动屏幕"""
        os.system("adb -s {} shell input swipe {} {} {} {} {}".format(device_id, left_up_x, left_up_y, right_down_x,
                                                                      right_down_y, steps))
